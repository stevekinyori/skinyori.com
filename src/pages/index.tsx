...
const aboutStats = [
  ...
  { label: "Companies worked with", value: "7+" },
];
...
const projects = [
  ...
  {
    title: "This website",
    description: "My personal website showcasing my portfolio and projects.",
    image: "/assets/portfolio.webm",
    href: "https://github.com/stevekinyori/skinyori.com",
  },
];
...
const services = [
  {
    ...
    description:
      "Leading cross-functional teams and delivering complex software projects on time and within budget, fostering collaboration and quality outcomes.",
    icon: Users,
  },
  {
    service: "Frontend Development",
    description:
      "Designing and developing scalable, high-performance frontend architectures using React and TypeScript, optimizing for performance and user experience.",
    icon: Code,
  },
  {
    service: "Backend Development",
    description:
      "Building robust, scalable backend systems using Node.js and Python, ensuring secure and reliable web applications across various industries.",
    icon: Server,
  },
  {
    service: "Cloud Infrastructure & DevOps",
    description:
      "Utilizing AWS services and implementing CI/CD pipelines to ensure seamless deployment, scalability, and security for cloud-based applications.",
    icon: Cloud,
  },
  {
    service: "Web Scraping & Automation",
    description:
      "Automating data extraction and deployment processes using Node.js, Python, and AWS, ensuring timely and accurate data collection.",
    icon: Zap,
  },
  {
    service: "Mentorship & Team Development",
    description:
      "Providing mentorship and technical guidance to team members, fostering professional growth and enhancing team performance.",
    icon: Lightbulb,
  },
  {
    service: "Cybersecurity & Best Practices",
    description:
      "Implementing security protocols and industry best practices to ensure data protection, secure access, and compliance in web applications.",
    icon: Shield,
  },
  {
    service: "Database Management",
    description:
      "Designing and managing databases, ensuring optimal performance and scalability for applications using MongoDB, PostgreSQL, MySQL, and DynamoDB.",
    icon: Database,
  },
  {
    service: "UI/UX Design Collaboration",
    description:
      "Collaborating with UX/UI teams to create seamless, user-friendly interfaces that drive engagement and conversion rates.",
    icon: Monitor,
  },
  {
    service: "Microservices & API Development",
    description:
      "Designing and developing microservice architectures and APIs, ensuring scalability, maintainability, and efficient data flow.",
    icon: Layers,
  },
  {
        ...
        >
          <div className={styles.intro}>
            <div
              ...
              className="flex flex-row items-center space-x-1.5 flex-nowrap overflow-x-auto scrollbar-hide px-2.5"
            >
            ...
            >
              <Link href="mailto:kinyorimorris@gmail.com" passHref>
                <Button>
